...
func GetAllOpenFundValue(callback func(r *colly.Response)) error {
	...
	url := fmt.Sprintf("http://fund.eastmoney.com/data/rankhandler.aspx?op=ph&dt=kf&ft=all&rs=&gs=0&sc=rzdf&st=desc&sd=%s&ed=%s&qdii=&tabSubtype=,,,,,&pi=1&pn=7000&dx=1&v=0.7591271236608264", date, date)
